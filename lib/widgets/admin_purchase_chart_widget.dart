// lib/widgets/admin_purchase_chart_widget.dart
import 'package:flutter/material.dart';

class AdminPurchaseChartWidget extends StatelessWidget {
  final List<Map<String, dynamic>> chartData;

  const AdminPurchaseChartWidget({Key? key, required this.chartData}) : super(key: key);
