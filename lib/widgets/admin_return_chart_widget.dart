// lib/widgets/admin_return_chart_widget.dart
import 'package:flutter/material.dart';

class AdminReturnChartWidget extends StatelessWidget {
  final List<Map<String, dynamic>> chartData;

  const AdminReturnChartWidget({Key? key, required this.chartData}) : super(key: key);
