// lib/widgets/manager_return_chart_widget.dart
import 'package:flutter/material.dart';

class ManagerReturnChartWidget extends StatelessWidget {
  final List<Map<String, dynamic>> chartData;

  const ManagerReturnChartWidget({Key? key, required this.chartData}) : super(key: key);
