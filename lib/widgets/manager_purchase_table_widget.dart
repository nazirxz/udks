// lib/widgets/manager_purchase_table_widget.dart
import 'package:flutter/material.dart';

class ManagerPurchaseTableWidget extends StatefulWidget {
  final List<Map<String, dynamic>> purchaseData;
  final List<String> categories;
  final Function(int) onView;
  final Function(String, String) onSearch;

  const ManagerPurchaseTableWidget({
    Key? key,
  ...
  @override
  _ManagerPurchaseTableWidgetState createState() => _ManagerPurchaseTableWidgetState();
}

class _ManagerPurchaseTableWidgetState extends State<ManagerPurchaseTableWidget> {
        ...
        child: Column(
          ...
          children: [
            ...
            Container(
              ...
              child: widget.purchaseData.isEmpty
                ? Container(
                ...
                : Column(
                    children: widget.purchaseData.asMap().entries.map((entry) {
